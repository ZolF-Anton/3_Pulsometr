...
$(document).ready(function () {
    $('.carousel__inner').slick({
        ...
        prevArrow:
            '<button type="button" class="slick-prev"><img src="iconz/red/chevron_left_solid.png" /></button>',
        nextArrow:
            '<button type="button" class="slick-next"><img src="iconz/red/chevron_right_solid.png" /></button>',
        slidesToShow: 1,
        slidesToScroll: 1,
        responsive: [
            {
